...
#include "simplified_gamma_variate.cuh"
    ...
    int const user_info_size)
{
    ...
    case BROWN_DENNIS:
        ...
        break;
	case SIMPLIFIED_GAMMA_VARIATE:
		calculate_simplified_gamma_variate(parameters, n_fits, n_points, value, derivative, point_index, fit_index, chunk_index, user_info, user_info_size);
    default:
        break;
    }
}
...
void configure_model(ModelID const model_id, int & n_parameters, int & n_dimensions)
{
	...
	case SIMPLIFIED_GAMMA_VARIATE:	n_parameters = 4; n_dimensions = 1; break;
    default:                                                        break;
    }
}
